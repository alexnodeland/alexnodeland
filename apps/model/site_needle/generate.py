...
WHICH_TEMPLATES = {
    ...
    "previous": [
        ...
        ("what was the job before his current one?", "before his current one"),
        ("who did he work for before that?", "before that"),
...
PROJECT_TEMPLATES = [
    ...
    "describe {project} for me",
    "what's {project} written in?",
    "is {project} something he built?",
    "tell me what {project} does",
    "{project}: what's that?",
    "open {project}",
]
...
SKILL_TEMPLATES = [
    ...
    "is {skill} in his skill set?",
    "does his CV mention {skill}?",
    "any {skill} on his resume?",
    "has he got {skill} skills?",
    "does he have a background in {skill}?",
    "is {skill} something he has done?",
    "{skill} — does he know it?",
    "would he be comfortable with {skill}?",
    "has Alex picked up {skill} along the way?",
    "does he work with {skill}?",
]
...
SECTION_TEMPLATES: dict[str, list[tuple[str, str]]] = {
    "about": [
        ...
        ("what kind of person is Alex?", "kind of person"),
        ("what is he about?", "about"),
        ("summarize who he is", "who he is"),
        ("what are his interests?", "interests"),
    ],
    "education": [
        ...
        ("which school did Alex attend?", "school"),
        ("what are his qualifications?", "qualifications"),
        ("does he have a degree in maths?", "degree"),
        ("what was his thesis about?", "thesis"),
    ],
    "skills": [
        ...
        ("what is he proficient in?", "proficient"),
        ("what are his strongest skills?", "strongest skills"),
        ("what does he know how to do?", "know how to do"),
    ],
    "experience": [
        ...
        ("what's his professional background?", "professional background"),
        ("which companies has he been at?", "companies"),
        ("how long has he been working?", "working"),
        ("what industries has he worked in?", "industries"),
    ],
    "projects": [
        ...
        ("what does he tinker with?", "tinker"),
        ("what libraries has Alex written?", "libraries"),
        ("what tools has he made?", "tools"),
    ],
    "writing": [
        ...
        ("where can I read his writing?", "read his writing"),
        ("has he written anything lately?", "written"),
        ("what's new on his blog?", "blog"),
        ("does Alex keep a blog?", "blog"),
    ],
    "press": [
        ...
        ("has he been quoted anywhere?", "quoted"),
        ("what have journalists written about him?", "journalists"),
        ("any news stories about Alex?", "news stories"),
    ],
    "consulting": [
        ...
        ("could Alex advise my team?", "advise"),
        ("do you take on outside projects?", "outside projects"),
        ("what does an engagement with him look like?", "engagement"),
        ("is he for hire?", "for hire"),
    ],
}
...
REFUSALS: dict[str, tuple[str, list[str]]] = {
    "general": ("general knowledge; no site tool answers it", [
        ...
        "how big is SoundCloud?",
        "what does Perch Insights sell?",
        "what is HPCwire?",
        "is Musiio still a company?",
        "what happened to Archanan?",
        "how many employees does Google have?",
        "what is the population of Singapore?",
        "what does CEWIT stand for?",
        "who founded Entrepreneur First?",
        "what is the weather in upstate new york?",
        "how old is the linux kernel?",
        "what is rust's borrow checker?",
        "who wrote the gatsby framework?",
    ]),
    ...
    "other_people": ("about someone else, not Alex", [
        ...
        "has Elon Musk worked at Google?",
        "is Bill Gates on linkedin?",
        "what has Sam Altman built?",
        "does Marie Curie know python?",
        "what did Ada Lovelace do at Babbage's company?",
        "how do I email Tim Berners-Lee?",
        "where did Richard Feynman study?",
        "what is Demis Hassabis's background?",
        "can I book a call with Jeff Bezos?",
        "what press coverage has Greta Thunberg had?",
        "what skills does Linus Torvalds have?",
        "tell me about Steve Jobs's first job",
        "is Taylor Swift available for consulting?",
        "what did John Carmack write about?",
        "does Andrew Ng do consulting?",
        "what projects has Karpathy released?",
        "what is Ilya Sutskever's current role?",
        "where does Guido van Rossum work now?",
    ]),
