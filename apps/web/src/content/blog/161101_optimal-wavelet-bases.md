...
this research was an attempt at a procedure for picking the basis for a given class of audio, instead of choosing by taste: define what optimal means for that class, then search the space of admissible bases against a real corpus. the search needed the iacs supercomputers. the criterion needed the mathematics.

[read the full article](https://www.cewit.org/programs/_documents/CEWITNewsletter_NOV2016.pdf), inside the november 2016 newsletter pdf.
