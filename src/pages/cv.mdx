  ...
  <div className="cv">
    <header className="cv-header">
      ...
      <div className="cv-contact">
        <p><strong>Location:</strong> {siteConfig.contact.location}</p>
        <p><strong>Email:</strong> {siteConfig.contact.email}</p>
        <p><strong>LinkedIn:</strong> {siteConfig.social.linkedin.replace('https://', '')}</p>
        <p><strong>Website:</strong> {siteConfig.contact.website}</p>
      </div>
    </header>
