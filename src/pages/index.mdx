  ...
  <div className="home">
    ...
    <section className="consulting">
      ...
      <div className="cta-buttons">
        <a href={`mailto:${siteConfig.contact.email}`} className="cta-button primary">
          Get in Touch
        </a>
        <a href={siteConfig.services.calendar} className="cta-button secondary" target="_blank" rel="noopener noreferrer">
          Schedule a Call
        </a>
      </div>
    </section>
          ...
          <section className="expertise">
            ...
            <div className="expertise-grid">
              <div className="expertise-item">
                ...
                <div className="expertise-title">Emerging Technologies</div>
                <div className="expertise-description">Adoption and integration of cutting-edge AI and computing technologies</div>
              </div>
              <div className="expertise-item">
                <span className="expertise-icon">⚙️</span>
                <div className="expertise-title">Technical Project Management</div>
                <div className="expertise-description">Leading cross-functional teams and managing complex technical initiatives</div>
              </div>
              <div className="expertise-item">
                <span className="expertise-icon">📊</span>
                <div className="expertise-title">Business Modeling</div>
                <div className="expertise-description">Strategic planning and financial modeling for scalable growth</div>
              </div>
              <div className="expertise-item">
                <span className="expertise-icon">🔍</span>
                <div className="expertise-title">Market Analysis</div>
                <div className="expertise-description">Technical market research and competitive intelligence</div>
              </div>
              <div className="expertise-item">
                <span className="expertise-icon">🎯</span>
                <div className="expertise-title">Go-to-Market Strategy</div>
                <div className="expertise-description">Product launch strategies and market entry planning</div>
              </div>
              <div className="expertise-item">
                <span className="expertise-icon">🛠️</span>
                <div className="expertise-title">Development Processes</div>
                <div className="expertise-description">Optimizing software development workflows and practices</div>
              </div>
            </div>
          </section>
