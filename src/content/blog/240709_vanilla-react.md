...
the repository is that page, kept readable. it is not competing with the frameworks. it is meant to be the thing you read first, so that when you adopt a framework you can tell which parts solve your problem and which parts solve the framework's. a lot of what gets called an agent is this loop with retries and logging around it.
