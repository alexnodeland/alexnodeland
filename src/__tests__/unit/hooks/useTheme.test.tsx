...
describe('useTheme Hook', () => {
  ...
  it('should toggle theme from light to dark', () => {
    ...
    expect(result.current.theme).toBe(THEMES.DARK);
    expect(document.documentElement.setAttribute).toHaveBeenCalledWith('data-theme', THEMES.DARK);
    expect(localStorage.setItem).toHaveBeenCalledWith(STORAGE_KEYS.THEME, THEMES.DARK);
  });
  ...
  it('should toggle theme from dark to light', () => {
    ...
    expect(result.current.theme).toBe(THEMES.LIGHT);
    expect(document.documentElement.setAttribute).toHaveBeenCalledWith('data-theme', THEMES.LIGHT);
    expect(localStorage.setItem).toHaveBeenCalledWith(STORAGE_KEYS.THEME, THEMES.LIGHT);
  });
