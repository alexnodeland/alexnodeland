...
const CellularAutomatonBackground: React.FC<AnimatedBackgroundProps> = ({ className, settings }) => {
  ...
  useEffect(() => {
    ...
    const material = new THREE.ShaderMaterial({
      uniforms: {
        ...
        uColorHighActivity: { value: new THREE.Vector3(...settings.colors.highActivity) },
